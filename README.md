...
[![Branches](.github/badges/branches.svg)](https://github.com/petbjo1/greeting-app/actions/workflows/code-coverage.yml)

A modern Spring Boot REST API boilerplate project that provides a simple greeting service. Built with Spring Boot 4.0 (snapshot) in Java.
...
- ❗ Feature flags
- 🔍 Code test coverage with Jacoco
